...
namespace FusionExamples.Tanknarok
{
    public class CameraStrategy_MultipleTargets : CameraStrategy
    {
        ...
        [Header("Camera Settings")] private float cameraTiltAngle = 90f;
        ...
        public override void Initialize()
        {
            ...
            _myCamera.transform.SetParent(transform, false);
            UpdateCamera();
        ...
        public void ResetCameraPosition()
        {
            ...
            _myCamera.transform.localPosition = _offset;
        ...
        void UpdatePositionAndRotation()
        {
            ...
            _myCamera.transform.localPosition = Vector3.Lerp(_myCamera.transform.localPosition, _offset, Time.fixedDeltaTime * 10f);
            _myCamera.transform.rotation = Quaternion.Lerp(_myCamera.transform.rotation, Quaternion.Euler(cameraTiltAngle, 0, 0), Time.fixedDeltaTime * 10f);
